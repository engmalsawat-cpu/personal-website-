...
const translations: Record<Lang, Record<string, string>> = {
  ...
  ar: {
    ...
    'about.p1': 'أنا محمد الصوت، مستشار في أنظمة سير العمل والذكاء الاصطناعي، مقيم في الرياض. أساعد الفرق على التراجع عن ضوضاء اليوم وبناء طريقة عمل تبدو أوضح وأهدأ وأسهل في التحسين.',
